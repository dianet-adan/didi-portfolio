            ...
            <div className="flex flex-wrap gap-3 mt-8">
              {folders.map((folder) => (
                <Link
                  ...
                  className="inline-flex items-center gap-2 font-display font-normal uppercase tracking-widest text-xs md:text-sm border-2 border-ink rounded-full px-4 py-2 shadow-[2px_2px_0_var(--ink)] hover:-translate-y-0.5 hover:shadow-[3px_3px_0_var(--ink)] transition-transform"
