  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="/projects"
          className="inline-flex items-center gap-2 font-display font-normal text-sm md:text-base uppercase tracking-widest border-2 border-ink rounded-full px-7 py-3.5 bg-red text-paper shadow-[4px_4px_0_var(--ink)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_var(--ink)] transition-all"
        >
          View projects <span aria-hidden="true">&rarr;</span>
        </Link>
        <Link
          href="/about"
          className="inline-flex items-center gap-2 font-display font-normal text-sm md:text-base uppercase tracking-widest border-2 border-ink rounded-full px-7 py-3.5 bg-yellow shadow-[4px_4px_0_var(--ink)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_var(--ink)] transition-all"
        >
          Get to know me
        </Link>
      </motion.div>
